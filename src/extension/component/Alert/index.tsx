...
import { CheckboxCircleFillIcon, CloseCircleFillIcon, ErrorWarningFillIcon, Information2FillIcon, ScrollToBottomLineIcon, TextIcon } from '@ctzhian/tiptap/component/Icons'
  ...
  return (
    <NodeViewWrapper
      ...
      style={{
        ...
        gap: '16px',
        background: `color-mix(in srgb, ${variantData.color} 10%, transparent)`,
      }}
      onClick={handleShowOperationPopover}
    >
      {showIcon && (
        <Box sx={{ pt: '2px', lineHeight: 1 }}>{variantData.icon}</Box>
      )}
      <Box sx={{ flex: 1 }}>
